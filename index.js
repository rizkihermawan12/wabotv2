...
* (Scriptnya Nfq cuy).
*/
const BotName = 'BOT RIZKOY V2'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/hermawanrisky02'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/6285803639392'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/JYNCOeG5OGcDanlqtIPuJj'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://youtube.com/channel/UCFP1cgQfnbLpkB3DEshAAsw'; // OFFICIAL YT LU
const grupch3 = 'https://chat.whatsapp.com/JYNCOeG5OGcDanlqtIPuJj'; // OFFICIAL GRUP LU 3
//
...
conn.sendMessage(id, 'PEMBUAT BOT= Wa.me/6285803639392' ,MessageType.text);
}
